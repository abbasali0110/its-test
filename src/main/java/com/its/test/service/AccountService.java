...
public class AccountService  {
    ...
    public Account addAccountForUser(String username, Account account) {
        ...
        Account accountExists = accountRepository.findByAccountNum(account.getAccountNum());
        if (accountExists != null) {
            throw new BadRequestException("Account already exists " + account.getAccountNum());
        }
